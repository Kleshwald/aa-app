...
// Вид заявки — СЛОВАМИ, без кодов ВИ/Р/УУ. Владелец подтвердил (2026-07-15): агенты
// между собой говорят «изменения» / «расторжение», а не «ВИ» / «Р». Код был нашей
// выдумкой из формы 1С (анти-референс, см. feedback_no_1c_as_reference), а не их
// терминологией — и на оси статуса полиса одинокая «Р» пугала бы («расторгнут?!»).
