...
export class ProfilePage {
  ...
  // Фото офиса убрано из профиля агента по фидбэку (тест 2026-07-07): агент не
  // всегда знает, что офис фотографируют; если нужно СК для верификации точки
  // продаж — это функция куратора/модерации, а не поле в профиле агента.
