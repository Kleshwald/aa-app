  ...
  protected readonly platform1c: HubCard[] = [
    {
      ...
      desc: 'Тот же функционал (клиенты · ОСАГО · договор · здоровье · пролонгация · сообщения) в языке интерфейса 1С 8.5: трёхзонное окно, жёлтый хром, светлая/тёмная тема. HTML-рендер, не запущенная форма.',
      href: 'https://claude.ai/code/artifact/5e4416c9-509a-4f5d-a1b1-57c2a77f75bb',
      badge: 'вживую',
      badgeKind: 'ok',
      external: true,
    },
