    ...
    sections: [
      {
        ...
        items: [
          'ОСАГО: довести перевод формы на Taiga UI (секции 2–5) — секция 1 готова.',
    ...
    sections: [
      {
        ...
        items: [
          ...
          'Формы — на дизайн-системе Taiga UI (tui-textfield/tuiInputDate/tuiSelect), не сырые нативные поля.',
        ],
      },
      {
