...
│   ├── profile/              ✅ профиль на 3 вкладки (Данные/реквизиты · Документы · Условия/КВ)
│   ├── team/                 ✅ Команда — сотрудники + субагенты (для ИП со штатом)
...
- **Sidebar — 9 пунктов:** Мои клиенты · Пролонгация · ОСАГО · Здоровье · Ипотека · Мои финансы · Обучение · Сообщения · **Команда** (последний — раздел для ИП со штатом: сотрудники + субагенты; одиночке-ФЛ по-хорошему не нужен — кандидат на условную видимость).
