...
├── shared/                   переиспользуемые компоненты (пока пусто)
├── features/                 страницы по доменам
│   ├── clients/              ✅ Мои клиенты
│   ├── osago/                ⏭ заглушка
│   ├── prolongation/         ⏭ заглушка
│   ├── health/, mortgage/, finance/, learning/, messages/  ⏭ заглушки
│   ├── profile/              ⏭ заглушка
...
- **Колонки таблицы клиентов = как в 1С** (10 колонок, не сокращать): ИКП · Дата · Куратор · Страхователь · Объект страхования · № полиса · Продукт · Цена · Статус · Страховая компания.
