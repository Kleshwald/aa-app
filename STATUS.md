...
| **Здоровье**: калькулятор НС/Антиклещ (тип/категория/срок/сумма) → котировки от СК (НС: Ренессанс+Согласие, Антиклещ: Ренессанс+Югория) с «Ещё предложения»/КВ → данные страхователя и застрахованных → эквайринг → статус «Оформлен». Флоу как ОСАГО | `src/app/features/health/health.page.{ts,html,scss}` | `1fa3179` |
