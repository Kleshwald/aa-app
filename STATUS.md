...
| **Обучение**: встроенная Tilda-страница (`agentacademy.ru/education`) через iframe — внутри кабинета, не наружу (+ запасная ссылка на случай X-Frame-Options) | `src/app/features/learning/learning.page.ts` | `4d30457` |
