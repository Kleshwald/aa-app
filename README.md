...
|------|----------|-----------|
| **[AGENTS.md](./AGENTS.md)** | AI (Codex, Cursor и др.) | Универсальная точка входа для AI-инструментов: правила, залоченные решения, регламент веток/PR |
| **[docs/ONBOARDING.md](./docs/ONBOARDING.md)** | Новые участники | Как подключиться: доступ к GitHub, запуск, контекст для своего AI, регламент работы |
